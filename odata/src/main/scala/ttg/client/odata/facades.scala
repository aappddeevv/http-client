...
/** An inner error popular from Microsoft OData web servers, odata webapi. */
@js.native
trait MicrosoftInnerError extends js.Object {
  var Message: js.UndefOr[String] = js.native
  var TypeName: js.UndefOr[String] = js.native
  var StackTrace: js.UndefOr[String] = js.native
  // nested impl specific debugging info
  var InnerError: js.UndefOr[MicrosoftInnerError] = js.native
}
